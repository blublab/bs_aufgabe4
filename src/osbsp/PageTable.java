...
public class PageTable {
  ...
  private PageTableEntry randomAlgorithm(PageTableEntry newPte) {
    // ToDo
	  //Alte Seite auswaehlen und """"verdraengen""""
	  
	  
	  int randPageNumber = (int) (Math.random() * pteRAMlist.size());
	  PageTableEntry pte_old = pteRAMlist.remove(randPageNumber);
	  
	  pteRAMlist.add(newPte);
	  
	  return pte_old; // hier alte verdrangte zurueckgeben
  }
